...
class AIResearchAgent:
    ...
    async def generate_research_report(
        ...
        try:
            ...
            prompt = registry.render_to_prompt("market-ai-research", {
                "genre": ", ".join(user_request.genres) if user_request.genres else "通用",
                "premise": user_request.additional_notes or "",
                "target_audience": "",
                "samples_data": json.dumps(historical_data, ensure_ascii=False, default=str),
            })
